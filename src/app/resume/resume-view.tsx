...
// Drop your compiled PDF here: public/Deepak_Kumar_Resume.pdf
const RESUME_PATH = "/Deepak_Kumar_Resume.pdf";

export default function ResumeView() {
  // Hide the global header on mobile while this page is mounted.
  // Avoids the dangerouslySetInnerHTML <style> tag React warning.
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-screen flex-col font-sans">
      ...
      {/* Using a scoped className added to body avoids the dangerouslySetInnerHTML
          script-tag React warning. The style is in globals.css (.resume-page header). */}
